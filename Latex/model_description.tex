...
Note that the number of MTZ constraints is $ O(n^2) $ therefore much less respect STSP model.\\
The number of values instead is more than the double $ n(n-1) + n = n^2 $. Computational consideration will be done in the next chapter.
