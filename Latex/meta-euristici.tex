...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\columnwidth]{../res/Ltabu_LA_time.png}
	\caption{Performance profile considering the execution time}
	\label{fig:tabu_search_diff_perform_time}

	\includegraphics[width=0.7\columnwidth]{../res/Ltabu_LA_lb.png}
	\caption{Performance profile considering the execution time}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=.6\columnwidth]{../res/lb_simulating_annealing_att48.png}
...
\end{figure}
\begin{figure}[h]
	\includegraphics[width=.6\columnwidth]{../res/lb_simulating_annealing_a280.png}
	\caption{Performance profile considering the execution time of 280 nodes file (a280.tsp) with time limit of 1000}
	\label{fig:simultaing_annealing_perform_time}

	\includegraphics[width=.6\columnwidth]{../res/lb_simulating_annealing_a280_500.png}
	\caption{Performance profile considering the execution time of 280 nodes file (a280.tsp) with time limit of 1000}
	\label{fig:simultaing_annealing_perform_time}

	\includegraphics[width=.6\columnwidth]{../res/lb_simulating_annealing_50_a280_500.png}
	\caption{Performance profile considering the execution time of 280 nodes file (a280.tsp) with time limit of 1000}
	\label{fig:simultaing_annealing_perform_time}
\end{figure}
